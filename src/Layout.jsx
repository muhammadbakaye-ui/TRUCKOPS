    ...
    <>
      ...
      <div className="flex overflow-hidden bg-background" style={{ height: '100dvh', paddingTop: 'env(safe-area-inset-top)' }}>
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <main ref={mainRef} className="flex-1 overflow-auto px-2 lg:px-4 pb-20 md:pb-0" style={{ paddingLeft: 'max(0.5rem, env(safe-area-inset-left))', paddingRight: 'max(0.5rem, env(safe-area-inset-right))' }}>
