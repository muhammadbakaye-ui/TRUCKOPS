...
export default function SubscriptionSuccess() {
  ...
  // If session_id present, came from Stripe checkout (new account, email with credentials sent)
  // If no session_id, came from in-app upgrade (already logged in)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-extrabold mb-3">
          {fromStripe ? "You're in!" : 'Subscription Active!'}
        </h1>
        <p className="text-slate-400 mb-6">
          {fromStripe
            ...
            : 'Your plan has been upgraded. All features are now unlocked for your account.'}
        </p>
        ...
        <Button
          ...
          onClick={() => window.location.href = fromStripe ? '/' : '/Dashboard'}
        >
          {fromStripe ? 'Go to Login' : 'Go to Dashboard'}
        </Button>
