      ...
      <div className="h-14 flex items-center px-4 border-b border-sidebar-border">
        {!collapsed && (
          <div className="flex items-center gap-2">
            <img src="https://media.base44.com/images/public/6a0409fc37a632ab53db20fd/5e47d1777_image.png" alt="TruckOps" className="w-6 h-6 object-contain" />
            <span className="font-bold text-sidebar-primary-foreground text-sm tracking-wide">TRUCKOPS</span>
          </div>
        )}
        {collapsed && <img src="https://media.base44.com/images/public/6a0409fc37a632ab53db20fd/5e47d1777_image.png" alt="TruckOps" className="w-6 h-6 object-contain mx-auto" />}
      </div>
      {!collapsed && (
