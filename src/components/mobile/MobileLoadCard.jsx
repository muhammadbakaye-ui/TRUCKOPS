          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div onClick={e => e.stopPropagation()}>
              <Select value={load.invoice_status || 'not_invoiced'} onValueChange={handleInvoiceStatusChange} disabled={savingStatus}>
                <SelectTrigger className={`h-7 text-[10px] px-1.5 border rounded-md font-medium w-28 ${INVOICE_STATUS_STYLES[load.invoice_status] || INVOICE_STATUS_STYLES.not_invoiced}`}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
