  ...
  <div class="info-grid">
    <div class="info-box">
      ...
      <div class="info-box-body">
        ...
        <div class="row"><span class="lbl">Load Type:</span><span class="val">${load.load_type || '—'}</span></div>
        <div class="row"><span class="lbl">Equipment:</span><span class="val">${(load.equipment_type || '—').replace(/_/g,' ').replace(/\b\w/g,l=>l.toUpperCase())}</span></div>
        ${load.commodity ? `<div class="row"><span class="lbl">Commodity:</span><span class="val">${load.commodity}</span></div>` : ''}
        ${load.weight ? `<div class="row"><span class="lbl">Weight:</span><span class="val">${load.weight.toLocaleString()} lbs</span></div>` : ''}
      </div>
    </div>
    <div class="info-box">
