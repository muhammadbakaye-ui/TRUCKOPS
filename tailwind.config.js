...
export default {
  ...
  safelist: [
    ...
    'bg-yellow-500/10', 'text-yellow-600', 'bg-blue-500/10', 'text-blue-600',
    'bg-orange-500/10', 'text-orange-600', 'bg-purple-500/10', 'text-purple-600',
    'bg-emerald-500/10', 'text-emerald-600', 'bg-amber-500/10', 'text-amber-600',
    'bg-cyan-500/10', 'text-cyan-600', 'bg-rose-500/10', 'text-rose-600',
